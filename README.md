...
My vim dot files. the `.vimrc` file is saved to [vimrc](https://github.com/weisongye/.vim/blob/master/vimrc).

Just run the following commands via terminal to get perfectly set up:

```console
$ cd ~/
$ git clone --recursive https://github.com/weisongye/.vim.git .vim
